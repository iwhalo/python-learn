...
class ShareDataProcessor:
    ...
    def using_value_and_array(self):
        ...
        logger.info("== 使用 Value 和 Array 共享数据 ==")
...
将 worker 函数从 using_value_and_array 方法中移出，定义为模块级函数 value_array_worker

将 worker 函数从 using_manager 方法中移出，定义为模块级函数 manager_worker
